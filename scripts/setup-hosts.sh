...
show_status() {
    ...
    echo "  Chaos Mesh:   http://chaos.drkube.local"
    echo "  Jaeger:       http://jaeger.drkube.local"
    echo "  Delivery:     http://delivery.drkube.local"
    echo ""
    ...
    echo "  Chaos Mesh:   http://chaos-drkube.huik.site"
    echo "  Jaeger:       http://jaeger-drkube.huik.site"
    echo ""
    echo "=========================================="
